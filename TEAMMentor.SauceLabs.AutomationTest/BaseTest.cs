...
namespace TEAMMentor.SauceLabs.AutomationTest
{
    ...
    [Row("chrome", "27", "Windows 7")] // run all tests in the fixture against chrome 31 for windows 7
    [Row("firefox", "31", "Windows 8.1")] // run all tests in the fixture against chrome 31 for windows 7
